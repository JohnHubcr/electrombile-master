...
import com.zenchn.electrombile.widget.PickerView.TimePickerView.Type;
import com.zenchn.electrombile.widget.PickerView.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_hour.setLabel(context.getString(R.string.pickerView_hours));// 添加文字
        wv_hour.setCurrentItem(h);

        wv_min = (WheelView) view.findViewById(R.id.min);
        wv_min.setAdapter(new NumericWheelAdapter(0, 59));
        wv_min.setLabel(context.getString(R.string.pickerView_minutes));// 添加文字
        wv_min.setCurrentItem(m);
    ...
    public String getTime() {
        ...
        sb.append((wv_year.getCurrentItem() + startYear)).append("-").append((wv_month.getCurrentItem() + 1)).append("-").append((wv_day.getCurrentItem() + 1)).append(" ")
                .append(wv_hour.getCurrentItem()).append(":").append(wv_min.getCurrentItem());
        return sb.toString();
    }
