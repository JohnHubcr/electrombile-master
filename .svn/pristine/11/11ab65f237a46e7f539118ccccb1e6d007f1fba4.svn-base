...
/**
 * 作    者：wangr on 2017/3/4 9:26
 * 描    述：
 * 修订记录：
 */
public interface ChargingOutletsView extends BaseView {
     ...
     * @param totalPages
     */
    void onSearchSuccess(List<ChargingStationInfo> stationInfoList, int pageNumber, int totalPages);
