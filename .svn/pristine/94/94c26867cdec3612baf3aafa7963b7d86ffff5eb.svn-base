...
public class BlurView extends RelativeLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        mDownSampling = typedArray.getInt(R.styleable.BlurView_downSampling, DEFAULT_DOWN_SAMPLING);
        setBlurRadius(typedArray.getFloat(R.styleable.BlurView_blurRadius, DEFAULT_BLUR_RADIUS));
        typedArray.recycle();
    }
