...
public class ACacheWrapper {
    ...
    public static void saveFeedbackInfo(FeedbackInfo feedbackInfo) {
        aCache.put(BuildConf.CacheKey.SAVE_FEEDBACK_INFO, feedbackInfo, 30 * 24 * 3600);
    }
