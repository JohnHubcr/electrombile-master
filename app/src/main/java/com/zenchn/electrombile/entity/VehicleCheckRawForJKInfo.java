 ...
 * 修订记录：
 */
public class VehicleCheckRawForJKInfo implements Serializable, Parcelable {
    ...
    public VehicleCheckRawForJKInfo() {
    }

    public VehicleCheckRawForJKInfo(String meterTroubleStatus, String chargerTrouble, String bmsTrouble, String controlTroubleStatus1, String controlTroubleStatus2, String ecuTrouble, String ecuOnlineCheck, String gyroscopeStatus) {
    ...
    protected VehicleCheckRawForJKInfo(Parcel in) {
    ...
    public static final Creator<VehicleCheckRawForJKInfo> CREATOR = new Creator<VehicleCheckRawForJKInfo>() {
        @Override
        public VehicleCheckRawForJKInfo createFromParcel(Parcel source) {
            return new VehicleCheckRawForJKInfo(source);
        }

        @Override
        public VehicleCheckRawForJKInfo[] newArray(int size) {
            return new VehicleCheckRawForJKInfo[size];
        }
    };
}
