package com.zenchn.electrombile.widget.GridpasswordView;

import com.zenchn.electrombile.R;
import com.zenchn.electrombile.widget.GridpasswordView.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.widget_gridpasswordview, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.widget_divider, null);
