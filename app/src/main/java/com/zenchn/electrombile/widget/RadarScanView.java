...
public class RadarScanView extends View {
    ...
    private int radarBorderWidth = dip2px(getContext(), 10);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        radarRadius = Math.min(centerX, centerY) - 2 * radarBorderWidth;
    ...
    private void init(AttributeSet attrs, Context context) {
        if (attrs != null) {
            ...
            radarBorderWidth = ta.getInteger(R.styleable.RadarScanView_radarBorderWidth, radarBorderWidth);
...
//                Color.parseColor("#59FAFAFA")};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, centerY, radarRadius + radarBorderWidth, mPaintFillOutSize);
        canvas.drawCircle(centerX, centerY, radarRadius + radarBorderWidth, mPaintStrokeOutSize);
