...
/**
 * 作者：wangr on 2016/12/15 10:40
 * 描述：
 */
public class BGAMeiTuanRefreshViewHolder extends BGARefreshViewHolder {

    protected BGAMeiTuanRefreshView mMeiTuanRefreshView;

    protected int mPullDownImageResId = -1;
    protected int mChangeToReleaseRefreshAnimResId = -1;
    protected int mRefreshingAnimResId = -1;
    ...
    public void changeToRefreshFinish() {
        mMeiTuanRefreshView.changeToRefreshFinish();
    }
