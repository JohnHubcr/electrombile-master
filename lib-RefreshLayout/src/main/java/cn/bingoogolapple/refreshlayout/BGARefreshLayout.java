...
public class BGARefreshLayout extends LinearLayout {
    ...
    public void setRefreshViewHolder(BGARefreshViewHolder refreshViewHolder) {
        if (mRefreshViewHolder == null) {//避免重复添加头或者脚
    ...
    private void handleRefreshStatusChanged() {
        switch (mCurrentRefreshStatus) {
            ...
            case REFRESHING:
                ...
                break;
            case REFRESH_FINISH:
                mRefreshViewHolder.changeToRefreshFinish();
                break;
            default:
                break;
        }
    ...
    public void endRefreshing() {
        if (mCurrentRefreshStatus == RefreshStatus.REFRESHING) {
            mCurrentRefreshStatus = RefreshStatus.REFRESH_FINISH;
            handleRefreshStatusChanged();
            hiddenRefreshHeaderView();
    ...
    public void hiddenRefreshHeaderView() {
        animator = ValueAnimator.ofInt(mWholeHeaderView.getPaddingTop(), mMinWholeHeaderViewPaddingTop);
        animator.setDuration(mRefreshViewHolder.getTopAnimDuration());
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (mCurrentRefreshStatus == RefreshStatus.REFRESH_FINISH) {
                    mCurrentRefreshStatus = RefreshStatus.IDLE;
                    handleRefreshStatusChanged();
                }
            }
    ...
    public enum RefreshStatus {
        IDLE, PULL_DOWN, RELEASE_REFRESH, REFRESHING, REFRESH_FINISH
    }
